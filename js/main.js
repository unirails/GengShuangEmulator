...
var sentences = [
  "#N#B的举动严重干涉了#A内政，严重违反国际法和国际关系基本准则，是赤裸裸的霸权行径，#A政府和人民坚决反对。",
  "#N罔顾事实、颠倒黑白，公然#B，性质极其恶劣，用心十分险恶，其根本目的是干涉#A内政，破坏中华民族实现伟大复兴的历史进程。",
  "#B只会让广大#A人民进一步认清#N的险恶用心和霸权本质，只会让#A人民更加众志成城。",
  "#A政府和#A人民坚决反对#N#B的行为，#A已就此向#N提出严正交涉和强烈抗议。",
  "#A强烈敦促#N不得#B，以免影响两国关系和两国在重要领域的合作。",
  "#A强烈谴责并坚决反对#N#B，已就此向#N提出了严正交涉。",
  "#N如果#B，不仅将损害#A利益，损害#A和#N关系，也将严重损害#N自身的利益。",
  "我们要正告#N，任何外国政府和势力都无权干预#A内政。",
  "#N的图谋注定失败。",
  "#A政府反对任何外部势力干预#A事务的决心坚定不移，维护国家主权、安全、发展利益的决心坚定不移。",
  "我们奉劝#N不要一意孤行，否则#A必将予以坚决反制，由此产生的一切后果必须由#N承担。",
  "希望#N个别人士能以开放的心态和客观公正的态度对待#A，不要无中生有。",
  "#N有关人士的陈词滥调充满了政治偏见与谎言。",
  "我要强调，#A内政不容任何外部反华势力指手画脚。",
  "#A一向秉持和平共处五项原则处理国与国关系，历来坚定奉行不干涉内政原则，主张各国根据自身国情选择发展道路。",
  "#N的拙劣表演充分暴露出其不可告人的险恶用心和政治企图。",
  "#A坚持走和平发展道路，积极为维护世界和平稳定贡献智慧力量。",
  "#A坚持对外开放，互利共赢，同世界分享#A发展的机遇。",
  "#N自己不愿意投入，却千方百计干扰破坏#A和其他国家开展合作。",
  "#N试图挑拨#A共产党和#A人民的关系，极其阴险。",
  "任何妄图否定#A的社会主义制度、挑拨#A共产党和#A人民关系的政治图谋都注定不会得逞！",
  "我要告诉#N一些政客，人贵有自知之明，请他还是趁早反省一下#N自身的问题，放弃偏见和执念，停止喋喋不休的反华聒噪。",
  "还是我们经常说的那句话，请#N不要高估自己的造谣能力，也不要低估别人的判断能力。谎言重复一千遍，依然还是谎言。",
  "对于#N干涉#A内政、损害#A利益的行径，#A必将采取有力措施坚决反制。任何人都不要低估#A维护国家主权、安全、发展利益的坚定决心。",
  "如果#N一意孤行，#A必将采取有力措施予以坚决反制。",
  "我们奉劝某些政客别再浪费#N纳税人的钱，无事生非。",
  "#A已就此向#N提出严正交涉，表达强烈抗议。",
  "我们敦促#N立即停止此类挑衅行为，不要逆势而动，避免损害地区的和平与安宁。#A将采取一切必要措施，坚定维护国家主权和安全。",
  "我们奉劝#N有关媒体和人士尊重已经明确无误的事实和真相，恪守起码的职业道德操守，放下意识形态偏见，摘掉有色眼镜，不要再做不负责任、徒增笑柄的事情。",
  "#N罔顾事实、混淆是非、违反公理，玩弄双重标准，公然插手香港事务，干涉#A内政，严重违反国际法和国际关系基本准则，#A对此表示强烈谴责和坚决反对。",
  "#N任何企图干预#A内政、阻碍#A发展的把戏都不会得逞，到头来只会是枉费心机一场空。",
  "#N这一恶劣行径不仅损害#A利益，也会损害#N自身的重要利益。",
  "我们希望#N认真对待#A的严正交涉和严正立场，立即停止不负责任的言行，停止干涉#A内政。",
  "同时，我们敦促#N在#A问题上要谨言慎行，不要再发出错误信号，不要再挑拨怂恿，不要再干涉#A内政。",
  "对于#N的错误做法，#A必将采取有力的措施坚决予以反制，坚定地维护自身主权、安全、发展利益。",
...
function generate() {
  ...
  if (n.length === 0 || b.length === 0 || a.length === 0) {
    Snackbar.show({
      pos: 'bottom-center',
    ...
    s.innerHTML = "<b>记者：</b>" + n + b + a + "对此有何回应？"
